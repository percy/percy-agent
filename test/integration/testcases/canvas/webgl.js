// Taken from:
// https://github.com/mrdoob/three.js/blob/7a3d9d99dcc1dfd35ef9638fe51a91d9b7449043/examples/webgl_geometry_shapes.html
...
function init() {
  ...
  var arcShape = new THREE.Shape().moveTo(50, 10).absarc(10, 10, 40, 0, Math.PI * 2, false);

  var holePath = new THREE.Path().moveTo(20, 10).absarc(10, 10, 10, 0, Math.PI * 2, true);

  arcShape.holes.push(holePath);

  // Smiley

  var smileyShape = new THREE.Shape().moveTo(80, 40).absarc(40, 40, 40, 0, Math.PI * 2, false);

  var smileyEye1Path = new THREE.Path().moveTo(35, 20).absellipse(25, 20, 10, 10, 0, Math.PI * 2, true);

  var smileyEye2Path = new THREE.Path().moveTo(65, 20).absarc(55, 20, 10, 0, Math.PI * 2, true);
  ...
  var splineShape = new THREE.Shape().moveTo(0, 0).splineThru(splinepts);
  ...
  //
  // preserveDrawingBuffer: true required for Percy
