...
_See code: [dist/commands/start.ts](https://github.com/percy/percy-agent/blob/v0.0.11/dist/commands/start.ts)_
...
_See code: [dist/commands/stop.ts](https://github.com/percy/percy-agent/blob/v0.0.11/dist/commands/stop.ts)_
<!-- commandsstop -->
