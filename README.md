...
@percy/agent/0.1.12 darwin-x64 node-v8.10.0
$ percy --help [COMMAND]
USAGE
  $ percy COMMAND
...
...
_See code: [dist/commands/exec.ts](https://github.com/percy/percy-agent/blob/v0.1.12/dist/commands/exec.ts)_
...
_See code: [dist/commands/finalize.ts](https://github.com/percy/percy-agent/blob/v0.1.12/dist/commands/finalize.ts)_
