...
@percy/agent/0.0.5 darwin-x64 node-v8.5.0
...
_See code: [dist/commands/percy-command.ts](https://github.com/percy/percy-agent/blob/v0.0.5/dist/commands/percy-command.ts)_
...
_See code: [dist/commands/stop.ts](https://github.com/percy/percy-agent/blob/v0.0.5/dist/commands/stop.ts)_
<!-- commandsstop -->
