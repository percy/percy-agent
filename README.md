...
_See code: [dist/commands/exec.ts](https://github.com/percy/percy-agent/blob/v0.0.46/dist/commands/exec.ts)_
...
_See code: [dist/commands/finalize.ts](https://github.com/percy/percy-agent/blob/v0.0.46/dist/commands/finalize.ts)_
